...
rng = np.random.default_rng(42)   # for noise, gradient check

targets_x = rng.uniform(0.1, 0.9, 25)
targets_y = rng.uniform(0.1, 0.9, 25)



# # targets in bottom half (tutorial: uniform(0.1, 0.9) x uniform(0.1, 0.5))
# # regular grid of sensors in the bottom half
...
# print(f"Number of observation points: {ntargets} ({nx_s}x{ny_s} regular grid)")
